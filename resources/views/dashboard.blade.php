                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="d-flex align-items-center mb-30">
                                <div class="me-15">
                                    <img src="{{asset('admintheme/images/avatar/avatar-1.png')}}" class="avatar avatar-lg rounded100 bg-primary-light" alt="" />
                                </div>
                            ...
                            <div class="d-flex align-items-center mb-30">
                                <div class="me-15">
                                    <img src="{{asset('admintheme/images/avatar/avatar-10.png')}}" class="avatar avatar-lg rounded100 bg-primary-light" alt="" />
                                </div>
                                <div class="d-flex flex-column flex-grow-1 fw-500">
                            ...
                            <div class="d-flex align-items-center mb-30">
                                <div class="me-15">
                                    <img src="{{asset('admintheme/images/avatar/avatar-11.png')}}" class="avatar avatar-lg rounded100 bg-primary-light" alt="" />
                                </div>
                                <div class="d-flex flex-column flex-grow-1 fw-500">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="me-15">
                                    <img src="{{asset('admintheme/images/avatar/avatar-12.png')}}" class="avatar avatar-lg rounded100 bg-primary-light" alt="" />
                                </div>
                                <div class="d-flex flex-column flex-grow-1 fw-500">
            ...
            <div class="box box-inverse box-info">
                <div class="box-body">
                    <a class="avatar float-start me-20" href="javascript:void(0)">
                        <img src="{{asset('admintheme/images/avatar/5.jpg')}}" alt="">
                    </a>
                    <div>
...
<script src="{{asset('admintheme/assets/vendor_components/moment/min/moment.min.js')}}"></script>
<script src="{{asset('admintheme/assets/vendor_components/fullcalendar/fullcalendar.js')}}"></script>
<script src="{{asset('admintheme/main/js/pages/dashboard.js')}}"></script>
<script src="{{asset('admintheme/main/js/pages/calendar-dash.js')}}"></script>
@endsection